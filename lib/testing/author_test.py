...
class TestAuthor:
    ...
    def test_add_article(self):
        ...
        article_3 = Article(author_1, magazine_2, "Carra Marble is so 2020")
    ...
    article_1 = Article(author_1, magazine_1, "How to wear a tutu with style")
    author_1.add_article(magazine_1, article_1)
    
    article_2 = Article(author_1, magazine_2, "Carrara Marble is so 2020")
    author_1.add_article(magazine_2, article_2)

    article_3 = Article(author_2, magazine_2, "2023 Eccentric Design Trends")
    author_2.add_article(magazine_2, article_3)
